...
<figure>
  <img src="./row-content-img-left.png" alt="Section composed of two columns with an image on the left and rich text on the right." eleventy:widths="600">
...
<figure>
  <img src="./row-content-img-right.png" alt="Section composed of two columns with an image on the right and rich text on the left." eleventy:widths="600">
